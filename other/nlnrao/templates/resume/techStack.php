<div class="resume-header-main"><b>My Techincal Stack (Skills Overview)</b><hr/></div>
...
<div class="card resume-card mb-3">
	<div class="card-body resume-cardBody">
	  ...
	  <div class="pt-3">
		<span class="grey-3"><b>Java Web/API Frameworks :</b> Spring Framework (With Modules of Spring Boot, Spring JPA, Spring AOP, Spring Security 
		and Spring Cloud) and Hibernate (XML-based and Annotation-based).</span> 
	  </div>
	  <div class="pt-3">
